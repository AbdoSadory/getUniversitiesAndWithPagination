  ...
  return (
    <section>
      <a
        ...
        href={uni.web_pages ? uni.web_pages : 'Not Available'}
        target="_blank"
        title={uni.name ? uni.name : 'Not Available'}
        onMouseOver={(e) => {
          e.stopPropagation()
          e.target.getAttribute('title') && e.target.setAttribute('title', '')
        }}
        onFocus={(e) => {
          e.stopPropagation()
          e.target.getAttribute('title') && e.target.setAttribute('title', '')
      ...
      >
        ...
        <ul className={`${styles.universityDetails} text-capitalize`}>
          <li>
            <span className="fw-bold">name:</span>{' '}
            {uni.name ? uni.name : 'Not Available'}
          </li>
          <li>
            <span className="fw-bold">country:</span>{' '}
            {uni.country ? uni.country : 'Not Available'}
          </li>
        </ul>
      </a>
    </section>
